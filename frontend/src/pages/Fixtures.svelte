  ...
  >
    <div class="glass-card p-4 sticky top-24">
      ...
      <div class="space-y-4">
        ...
        <div>
          <div
            class="text-xs font-semibold text-yellow-400 uppercase tracking-wider mb-2 px-3"
          >
            European
          </div>
          <div class="space-y-1">
        ...
        <div>
          <div
            class="text-xs font-semibold text-accent uppercase tracking-wider mb-2 px-3 pt-2 border-t border-white/10"
          >
            Top Leagues
          </div>
          <div class="space-y-1">
        ...
        <div>
          <div
            class="text-xs font-semibold text-emerald-400 uppercase tracking-wider mb-2 px-3 pt-2 border-t border-white/10"
          >
            Second Divisions
          </div>
          <div class="space-y-1">
        ...
        <div>
          <div
            class="text-xs font-semibold text-orange-400 uppercase tracking-wider mb-2 px-3 pt-2 border-t border-white/10"
          >
            Domestic Cups
          </div>
          <div class="space-y-1">
      ...
      <div class="flex items-center justify-between gap-3">
        <div>
          ...
          <p class="text-sm text-slate-400">
            One game per team • Predictions on demand
          </p>
        </div>
        <button
    ...
    >
      <div class="flex items-start gap-2">
        ...
        <p class="text-slate-300">
          <strong class="text-white">Smart Fixtures:</strong> Showing one upcoming
          game per team. Click "Get AI Prediction" to load analysis on demand.
        </p>
      </div>
    </div>
      ...
      <div class="mt-4 text-center text-sm text-slate-500">
        ...
        {#if fixtures.length > deduplicatedFixtures.length}
          <p class="text-xs text-slate-600 mt-1">
            {fixtures.length - deduplicatedFixtures.length} additional fixtures filtered
            out
          </p>
        {/if}
      </div>
